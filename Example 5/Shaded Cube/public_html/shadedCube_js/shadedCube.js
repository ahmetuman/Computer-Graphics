...
window.onload = function init() {
    ...
    var image = document.getElementById("cube-texture");
    ...
    function updateLightPosition() {
        ...
        lightDisplay.textContent = `Light Position: (${lightPosition[0].toFixed(2)}, ${lightPosition[1].toFixed(2)}, ${lightPosition[2].toFixed(2)})`;
    }
